...
<body>
        ...
        <div class="container"><a class="navbar-brand logo" href="#">
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="index.php">Agent</a></li>
    ...
    <main class="page landing-page">
        ...
        <form method="post">
            <h1><center><strong>Admin</strong></center></h1>
            <?php
            if(@$_GET['Empty']==true){
                ?>
            ...
            <div class="form-group"><input class="form-control" type="text" name="login" placeholder="log in Admin"></div>
 ...
 <?php
  ...
  if(isset($_POST['con'])){
    ...
    $password=$_POST['password'];
            $query="select login,motpasse from admin where login=:login and motpasse=:password";
